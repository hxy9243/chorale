...
describe('SheetMusicView Component', () => {
  ...
  it('renders interactive annotations in a view-box-aligned React sibling overlay', async () => {
    ...
    expect(chordEditor.closest('.annotation-rail')).not.toBeNull();
    expect(chordEditor.closest('.annotation-chord-inline-editor')).toBeNull();
    expect(screen.getByLabelText('Kind')).toBeDefined();
    expect(screen.getByLabelText('Start measure')).toBeDefined();
    expect(screen.getByLabelText('End measure')).toBeDefined();
    expect(screen.getByLabelText('Beat')).toBeDefined();
    ...
    expect(screen.getByLabelText('Explanation')).toBeDefined();
