...
- [score-surface.md](./score-surface.md): rendered score behavior, continuous range selection, chord overlays, the range annotation rail, auto-centering playback, line measure numbers, and score UI
